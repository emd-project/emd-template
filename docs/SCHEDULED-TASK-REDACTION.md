...
# 7 — Images : 1 cover GÉNÉRÉE + 1 in-content RÉUTILISÉE. Rien d'autre.
...
# 11 — Calendrier + PROGRESS : cocher le sujet (+ le brief priorites-geo si applicable), entrée PROGRESS (slug, cat, head term, marques citées, nombre de mots, commit, coût 1 cover).

# 12 — Hard rules
- JAMAIS publier sans SERP analysis (étape 2).
- JAMAIS sous le plancher de longueur (étape 5), dans aucune locale.
...
# 14 — Output final (8-12 lignes) : slug(s) ou échec + raison · cat · head term · marques citées · **nombre de mots par locale** · commit · coût image.
```
...
- **SERP-first** · **GEO 2026** (Answer-Explanation-Example + Expérience) · **images économes** (1 cover générée + 1 réemploi) · **miroir conditionnel** · **année dynamique**.
