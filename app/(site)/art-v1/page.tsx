/**
 * Preview variante article « classic ». noindex — supprimé à l'init.
...
export const metadata: Metadata = {
  title: 'Preview — Article classic',
  robots: { index: false, follow: false },
}

export default async function PreviewArtV1() {
  ...
  return <ArticleView locale="fr" variant="classic" categorie={first.categorie} slug={first.slug} meta={meta} content={content} related={related} />
}
